...
// Final booking data generator - matches actual database schema
...
const generateFinalBookingData = async () => {
  console.log('🌱 Starting final booking data generation...');
    ...
    for (let month = 0; month < 3; month++) {
      ...
      for (let i = 1; i <= 100; i++) {
        ...
        const bookingData = {
          ...
          bookingNumber: generateBookingNumber(companyCode, bookingCounter),
  ...
  console.log(`\n🎉 Final booking data generation completed!`);
...
async function main() {
  console.log('🚀 Starting final booking data seed...');
  
  try {
    await generateFinalBookingData();
  } catch (error) {
