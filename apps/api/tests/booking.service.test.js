...
const booking_service_1 = require("../src/modules/booking/booking.service");
...
describe('BookingService', () => {
    ...
    beforeEach(() => {
        ...
        service = new booking_service_1.BookingService(prisma);
        jest.clearAllMocks();
    });
    describe('create', () => {
        it('should create a booking with valid data', async () => {
            const createDto = {
                customerName: '홍길동',
                teamName: 'A팀',
                bookingType: client_1.BookingType.PACKAGE,
                destination: '제주도',
        ...
        it('should handle null JSON fields correctly', async () => {
            const createDto = {
                customerName: '김철수',
                teamName: 'B팀',
                bookingType: client_1.BookingType.FIT,
                destination: '부산',
    ...
    describe('update', () => {
        ...
        it('should handle null JSON fields in update', async () => {
            ...
            const callArgs = prisma.booking.update.mock.calls[0][0];
