...
ALTER TABLE "Booking" ADD COLUMN IF NOT EXISTS "companyCode" TEXT NOT NULL DEFAULT 'ENTRIP_MAIN';

ALTER TABLE "CalendarEvent" ADD COLUMN IF NOT EXISTS "createdById" TEXT;
ALTER TABLE "CalendarEvent" ADD COLUMN IF NOT EXISTS "companyCode" TEXT NOT NULL DEFAULT 'ENTRIP_MAIN';

ALTER TABLE "FinanceRecord" ADD COLUMN IF NOT EXISTS "createdById" TEXT;
ALTER TABLE "FinanceRecord" ADD COLUMN IF NOT EXISTS "approvedById" TEXT;
ALTER TABLE "FinanceRecord" ADD COLUMN IF NOT EXISTS "companyCode" TEXT NOT NULL DEFAULT 'ENTRIP_MAIN';

ALTER TABLE "Approval" ADD COLUMN IF NOT EXISTS "companyCode" TEXT NOT NULL DEFAULT 'ENTRIP_MAIN';
ALTER TABLE "Account" ADD COLUMN IF NOT EXISTS "companyCode" TEXT NOT NULL DEFAULT 'ENTRIP_MAIN';
